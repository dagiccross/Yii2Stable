  ...
  <div class="col-sm-4 middle-content">
    <div class="login-form">
      ...
      if ($map_calculation == 0){
        ...
        <?=Html::tag('p','CITY/TOWN <small style="color:red;">(please select the correct city/town)</small>',['class'=>'lotitle'])?>
        <?=Html::dropdownlist('shipment[shipment_postcode]',$shipment['shipment_city'],getShipmentPostcode(),['class'=>'poselect','style'=>'width:100%;'])?>
