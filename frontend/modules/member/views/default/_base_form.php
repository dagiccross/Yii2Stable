    ...
    <h3 class="form-title">Your details:</h3>
      <div class="row form-group">
        ...
        <div class="col-sm-8 control">
          <?=Html::activeTextInput($member,'email',['class'=>'acount-input','placeholder'=>'example@yahoo.co.uk'])?>
        </div>
      </div>
    ...
    <h3 class="form-title">Delivery address:</h3>
      ...
      <div class="row form-group">
        ...
        <div class="col-sm-8 control">
          ...
          if ($map_calculation == 0){
          ?>
          <?=Html::activeTextInput($addr,'shipment_postcode2',['class'=>'postcode-input','style'=>'text-transform:uppercase;','maxlength'=> 8])?>
          <?php } elseif ($map_calculation == 1){ ?>
