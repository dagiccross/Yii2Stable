    ...
    if ((map_cal) == 0){
      ...
      $.ajax({
        ...
        success: function (response) {
          if(response == "true"){
            // modal_alert("Yes, we do deliver to your postcode.");
            // return false;
            doPassDeliverStepOne();
          }else{
            modal_alert("Sorry, we currently don\'t deliver to your postcode");
            return false;
          }
        }
      });
...
var CART = {
  ...
  formSubmit:function(){
    ...
    if(typeof(send)=='undefined'){
      console.log(send);
      //alert(send);
      modal_alert("Please checked Collection or Delivery!");
      return false;
    }
